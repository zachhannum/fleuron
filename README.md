...
block quotes, scene breaks, drop caps, images, lists, tables, running
heads, multi-column pages, and page furniture like recto and verso,
page counters and named pages.
