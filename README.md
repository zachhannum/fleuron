...
block quotes, scene breaks, drop caps, images, lists, tables, code
blocks, running heads, multi-column pages, and page furniture like
recto and verso, page counters and named pages.
