...
|                                                    |                                                                                                                                                                                                                                                           |
| -------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| a construct the content structure does not support | A footnote, a definition list, strikethrough. The frontend falls back to plain prose and names the line and column. Prose is never dropped, so the page has changed shape rather than lost anything. [The markdown mapping](../reference/markdown.mdx) is the full list. |
