...
```js
// A manuscript's urls mean whatever the host says they mean. This
// one serves them from a directory; another might read a database,
// or an editor's unsaved buffer.
