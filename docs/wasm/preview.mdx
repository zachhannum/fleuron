...
`![a plate](plates/frontispiece.jpg)` in a manuscript is a url and nothing else. Nothing in the package will go and fetch it, so fetch it yourself and hand over what comes back:
