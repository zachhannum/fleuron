...
| footnotes | `::footnote-call` and `::footnote-marker`, a note set in the margin or at the end of the book, `float: footnote`, and a rule that reaches the area of one page rather than every page |
