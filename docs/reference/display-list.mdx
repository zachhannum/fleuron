...
<Playground
  ...
  editors="markdown"
  highlight="baselines"
  caption="Every text run of a page, with a rule drawn on the y the display list gave it. The rules sit on the letters rather than above them, which is what a baseline is. Edit the manuscript and the rules move with the runs."
/>
