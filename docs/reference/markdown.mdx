...
The url means whatever the host says it means: the engine opens nothing. A host supplies the bytes, the engine reads the header for the intrinsic size, and a url nobody supplies is a warning and a gap.
