...
mod tests {
    ...
    fn examples_read_into_their_own_property() {
        ...
        check(PAGE_PROPERTIES, |declaration| match declaration {
            ...
            PageDeclaration::BackgroundColor(_) => "background-color",
            PageDeclaration::BackgroundImage(_) => "background-image",
            PageDeclaration::BackgroundRepeat(_) => "background-repeat",
            PageDeclaration::BackgroundSize(_) => "background-size",
            PageDeclaration::BackgroundPosition(..) => "background-position",
